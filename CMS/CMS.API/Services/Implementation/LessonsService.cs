...
namespace CMS.API.Services
{
    public class LessonsService : ILessonsService
    {
       ...
       private readonly IMapper _mapper;
        ...
        public async Task<bool> UpdateCompletionStatus(string lessonId, bool completed)
        {
            var result = await _lessonsRepo.UpdateCompletionStatus(lessonId, completed);
            return result;
        }

        public async Task<List<QuizDto>> GetQuizzesByLessonId(string lessonId)
        {
            // Retrieve quizzes associated with the specified lessonId
            return await _lessonsRepo.GetQuizzesByLessonId(lessonId);
